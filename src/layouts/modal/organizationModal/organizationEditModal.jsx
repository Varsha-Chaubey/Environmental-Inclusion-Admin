  ...
  return (
    ...
    >
      <Offcanvas.Header className="offcanvas-header filter-margin">
        <h5 className="offcanvas-title">Edit an Organization</h5>
        <button
          type="button"
      ...
      <Offcanvas.Body className="offcanvas-body p-0">
        <div className="offcanvas-widget-row pt-0 filter-margin">
          <div className="mb-30">
            ...
            <input
              value={
                selectOrganization && selectOrganization.name
          ...
          <div className="form-group">
            ...
            <Select
              value={
                ...
                selectOrganization.regions.map((item) =>
                  item.country == "US"
          ...
          <div className="form-group mb-30">
            ...
            <Select
              value={
                selectOrganization && selectOrganization.species
                  ? selectOrganization.species
                  : ""
              }
              className="basic-single"
              classNamePrefix="select-search"
              ...
              <span className="file-input">
                ...
                >
                  ...
                  selectedImage
                    ...
                    ? selectOrganization.coverImage.original.length > 40
                      ? selectOrganization.coverImage.original.substring(
                          0,
                          40
                        ) + "..."
                      : selectOrganization.coverImage.original
          ...
          {selectOrganization && selectOrganization.coverImage ? (
            <>
              {selectOrganization &&
              selectOrganization.coverImage &&
              selectOrganization.coverImage.original ? (
                  ...
                  <img
                    src={
                      ...
                      `${
                        selectOrganization &&
                        selectOrganization.coverImage &&
                        selectOrganization.coverImage.small
                      }`
                    }
                    alt=""
            ...
            <div className="upload-lg-button position-relative">
              <span className="file-input">
                ...
                >
                  ...
                  selectedBannerImage
                    ? selectedBannerImage.name.length > 40
                      ? selectedBannerImage.name.substring(0, 40) + "..."
                      : selectedBannerImage.name
                    : selectOrganization &&
                      selectOrganization.bannerImage &&
                      selectOrganization.bannerImage.original
                    ? selectOrganization.bannerImage.original.length > 40
                      ? selectOrganization.bannerImage.original.substring(
                          0,
                          40
                        ) + "..."
                      : selectOrganization.bannerImage.original
          ...
          {selectOrganization && selectOrganization.bannerImage ? (
            <>
              {selectOrganization &&
              selectOrganization.bannerImage &&
              selectOrganization.bannerImage.original ? (
                  ...
                  <img
                    src={
                      ...
                      `${
                        selectOrganization &&
                        selectOrganization.bannerImage &&
                        selectOrganization.bannerImage.small
                      }`
                    }
                    alt=""
                    style={{ border: "solid 1px #dee2e6" }}
                ...
                <>
                  {selectedBannerImage !== null && bannerSrc && (
                    <div className="td-img-dev mt-3 mb-3">
                      <img
                        src={bannerSrc}
                        alt="Image Preview"
            ...
            <div className="upload-lg-button position-relative">
              <span className="file-input">
                ...
                >
                  ...
                  selectedDetailTabImage
                    ? selectedDetailTabImage.name.length > 40
                      ? selectedDetailTabImage.name.substring(0, 40) + "..."
                      : selectedDetailTabImage.name
                    : selectOrganization &&
                      selectOrganization.detailTabImage &&
                      selectOrganization.detailTabImage.original
                    ? selectOrganization.detailTabImage.original.length > 40
                      ? selectOrganization.detailTabImage.original.substring(
                          0,
                          40
                        ) + "..."
                      : selectOrganization.detailTabImage.original
          ...
          {selectOrganization && selectOrganization.detailTabImage ? (
            <>
              {selectOrganization &&
              selectOrganization.detailTabImage &&
              selectOrganization.detailTabImage.original ? (
                  ...
                  <img
                    src={
                      ...
                      `${
                        selectOrganization &&
                        selectOrganization.detailTabImage &&
                        selectOrganization.detailTabImage.small
                      }`
                    }
                    alt=""
                    style={{ border: "solid 1px #dee2e6" }}
                ...
                <>
                  {selectedDetailTabImage !== null && detailSrc && (
                    <div className="td-img-dev mt-3 mb-3">
                      <img
                        src={detailSrc}
                        alt="Image Preview"
          ...
          <div className="mb-30">
            ...
            <input
              value={
                selectOrganization && selectOrganization.yearsOfWorking
                  ? selectOrganization.yearsOfWorking
                  : ""
              }
              type="text"
          ...
          <div className="mb-30">
            ...
            <input
              value={
                selectOrganization && selectOrganization.animalLivesSaved
                  ? selectOrganization.animalLivesSaved
                  : ""
              }
              type="text"
              className="form-control text-in "
          ...
          <div className="mb-30">
            ...
            <input
              value={
                selectOrganization && selectOrganization.areaOfHabitatCovered
                  ? selectOrganization.areaOfHabitatCovered
                  : ""
              }
              type="text"
              className="form-control text-in "
          ...
          <div className="mb-30">
            ...
            <input
              value={
                selectOrganization && selectOrganization.amountInvested
                  ? selectOrganization.amountInvested
                  : ""
              }
              type="text"
              className="form-control text-in "
          ...
          <div className="mb-30">
            ...
            <input
              value={
                selectOrganization && selectOrganization.animalReceivingCare
                  ? selectOrganization.animalReceivingCare
                  : ""
              }
              type="text"
              className="form-control text-in "
          ...
          <div className="mb-30">
            ...
            <input
              value={
                selectOrganization && selectOrganization.helpingHands
                  ? selectOrganization.helpingHands
                  : ""
              }
              type="text"
              className="form-control text-in "
          ...
          <div className="mb-30">
            ...
            <input
              value={
                selectOrganization && selectOrganization.websiteUrl
                  ? selectOrganization.websiteUrl
                  : ""
              }
              type="text"
              className="form-control text-in "
          ...
          <div className="mb-30">
            ...
            <input
              type="text"
              value={
                selectOrganization && selectOrganization.donationUrl
                  ? selectOrganization.donationUrl
                  : ""
              }
              className="form-control w-100 text-in "
              onChange={(e) => {
          ...
          <div className="mb-30">
            ...
            <input
              type="text"
              value={
                selectOrganization?.address ? selectOrganization?.address : ""
              }
              className="form-control w-100 text-in"
              onChange={(e) => {
                const data = { ...selectOrganization };
          ...
          <div className="form-group mb-30">
            ...
            <Select
              value={{
                name: selectOrganizationLocation?.countryName,
                value: selectOrganizationLocation?.countryID,
              }}
              className="basic-single "
              classNamePrefix="select-search"
              placeholder="Select"
          ...
          (selectOrganizationLocation &&
            ...
            <>
              <div className="mb-30">
                ...
                <Select
                  value={{
                    name: selectOrganizationLocation?.stateName,
                    value: selectOrganizationLocation?.stateID,
                  }}
                  className="basic-single "
                  classNamePrefix="select-search "
                  placeholder="Select"
            ...
            <div className="mb-30">
              ...
              <input
                type="text"
                value={selectOrganizationLocation?.stateName}
                className="form-control w-100 text-in"
                onChange={(e) => {
                  const data = { ...selectOrganizationLocation };
          ...
          (selectOrganizationLocation &&
            ...
            <>
              <div className="mb-30">
                ...
                <Select
                  value={{
                    name: selectOrganizationLocation?.cityName,
                    value: selectOrganizationLocation?.cityID,
                  }}
                  className="basic-single "
                  classNamePrefix="select-search "
                  placeholder="Select"
            ...
            <div className="mb-30">
              ...
              <input
                type="text"
                value={selectOrganizationLocation?.cityName}
                className="form-control w-100 text-in"
                onChange={(e) => {
                  const data = { ...selectOrganizationLocation };
          ...
          <div className="mb-30">
            ...
            <input
              type="number"
              value={
                selectOrganization?.zipCode ? selectOrganization?.zipCode : ""
              }
              className="form-control w-100 text-in"
              onChange={(e) => {
                const data = { ...selectOrganization };
          ...
          <div className="mb-30 d-flex justify-content-between">
            ...
            <input
              ...
              value={selectOrganizationLocation?.isAddedToDonation}
