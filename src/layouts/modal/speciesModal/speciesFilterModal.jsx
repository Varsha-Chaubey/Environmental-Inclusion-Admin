...
const SpeciesFilterModal = (props) => {
  const {
    show,
    onHide,
    regionsDropdownData,
      ...
      <div className="offcanvas-body p-0">
        <div className="offcanvas-widget-row pt-0 filter-margin">
          ...
          <div className="form-group">
            ...
            <Select
              value={{
                name: filterState?.dangerLevelName,
                value: filterState?.dangerLevel,
              }}
              className="basic-single"
              classNamePrefix="select-search"
              placeholder="Select"
          ...
          <div className="form-group">
            ...
            <Select
              value={{
                name: filterState?.speciesCategoryName,
                value: filterState?.speciesCategory,
              }}
              className="basic-single"
              classNamePrefix="select-search"
              placeholder="Select"
              ...
              name={categoriesDropdownData && categoriesDropdownData.id}
              onChange={(event) => {
                const data = { ...filterState };
...
export default SpeciesFilterModal;
