  ...
  return (
    ...
    >
      <Offcanvas.Header className="offcanvas-header filter-margin">
        <h5 className="offcanvas-title">Edit a Zoo</h5>
        <button
          type="button"
      ...
      <Offcanvas.Body className="offcanvas-body p-0">
        <div className="offcanvas-widget-row pt-0 filter-margin">
          <div className="mb-30">
            ...
            <input
              value={selectZoo && selectZoo.name ? selectZoo.name : ""}
              type="text"
          ...
          <div className="form-group">
            ...
            <Select
              value={
                selectZoo &&
                selectZoo.regions &&
                selectZoo.regions.length > 0 &&
                selectZoo.regions.map((item) =>
                  item.country == "US"
          ...
          <div className="form-group">
            ...
            <Select
              value={selectZoo && selectZoo.species ? selectZoo.species : ""}
              className="basic-single"
              classNamePrefix="select-search"
              isMulti
              placeholder="Select"
          ...
          <div className="form-group mb-30">
            ...
            <Select
              value={
                selectZoo && selectZoo.organizations
                  ? selectZoo.organizations
                  : ""
              }
              className="basic-single"
              classNamePrefix="select-search"
          ...
          <div className="mb-30">
            ...
            <input
              type="text"
              value={selectZoo?.address ? selectZoo?.address : ""}
              className="form-control w-100 text-in"
              onChange={(e) => {
                const data = { ...selectZoo };
          ...
          <div className="form-group mb-30">
            ...
            <Select
              value={{
                name: selectZooLocation?.countryName,
                value: selectZooLocation?.countryID,
              }}
              className="basic-single "
              classNamePrefix="select-search "
              placeholder="Select"
          ...
          {(selectZooLocation &&
            ...
            <>
              <div className="mb-30">
                ...
                <Select
                  value={{
                    name: selectZooLocation?.stateName,
                    value: selectZooLocation?.stateID,
                  }}
                  className="basic-single "
                  classNamePrefix="select-search "
                  placeholder="Select"
            ...
            <div className="mb-30">
              ...
              <input
                type="text"
                value={selectZooLocation?.stateName}
                className="form-control w-100 text-in"
                onChange={(e) => {
                  const data = { ...selectZooLocation };
          ...
          {(selectZooLocation &&
            ...
            <>
              <div className="mb-30">
                ...
                <Select
                  value={{
                    name: selectZooLocation?.cityName,
                    value: selectZooLocation?.cityID,
                  }}
                  className="basic-single "
                  classNamePrefix="select-search "
                  placeholder="Select"
            ...
            <div className="mb-30">
              ...
              <input
                type="text"
                value={selectZooLocation?.cityName}
                className="form-control w-100 text-in"
                onChange={(e) => {
                  const data = { ...selectZooLocation };
          ...
          <div className="mb-30">
            ...
            <input
              type="number"
              value={selectZoo?.zipCode ? selectZoo?.zipCode : ""}
              className="form-control w-100 text-in"
              onChange={(e) => {
                const data = { ...selectZoo };
          ...
          <div className="mb-30">
            ...
            <div className="upload-lg-button position-relative">
              <span className="file-input">
                ...
                >
                  {selectZoo && selectZoo.newImage && selectedImage
                    ? selectedImage.name.length > 40
                      ? selectedImage.name.substring(0, 40) + "..."
                      : selectedImage.name
                    : selectZoo &&
                      selectZoo.coverImage &&
                      selectZoo.coverImage.original
                      ? selectZoo.coverImage.original.length > 40
                        ? selectZoo.coverImage.original.substring(0, 40) + "..."
                        : selectZoo.coverImage.original
                      : ""}
          ...
          {selectZoo && selectZoo.coverImage ? (
            <>
              {selectZoo &&
                selectZoo.coverImage &&
                selectZoo.coverImage.original ? (
