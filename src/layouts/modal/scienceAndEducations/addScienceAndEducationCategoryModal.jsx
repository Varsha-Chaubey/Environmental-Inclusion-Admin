...
const AddScienceAndEducationCategoryModal = (props) => {
  ...
  return (
    ...
    >
      <Offcanvas.Header className="offcanvas-header filter-margin">
        <h5 className="offcanvas-title">Add a Science And Education Category </h5>
        <button
          type="button"
        ...
        <div className="offcanvas-widget-row pt-0 filter-margin">
          <div className="form-group mb-30">
            ...
            <input
              ...
              id="name"
              onChange={(e) => {
                setSelectScienceCategory(e.target.value);
              }}
            />
          </div>
        </div>
...
export default AddScienceAndEducationCategoryModal;
